...
<html lang="en">
  <head>
    ...
    <title>Class 06 - Students - ABC School</title>
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Class 06 <small>Present Students'<?php echo $newYear;?></small></h3>
              </div>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-responsive" class="table table-striped table-bordered">
                      ...
                      $sql = "SELECT * FROM present_student WHERE chooseclass = 'c06'";
                      $result = mysqli_query($conn, $sql);
                        ...
                        while($row = mysqli_fetch_assoc($result))
                          {
                           //   foreach($row as $key => $value)
                            //  {
                                  ...
                                  <tr>
                                    <td>".$row['sid']."</td>
                                    <td><strong>".$row['fname']." ".$row['lname']."</strong><br>
                                        <small>Gender : ".ucfirst($row['gender'])."<br>
                                        Email : <i>".$row['email']."</i><br>
                                        Phone : ".$row['phoneno']."</small></td>
                                    <td>das</td>
                                    <td>das</td>
                                    <td><center>
                                    <form action='stu_result_c06.php' method='post'>
                            <input type='hidden' name='sl' value='".$row['sid']."'>
                            <input type='hidden' name='year' value='$year'>
                            <button type='submit' name='result' value='viewind' class='btn btn-success btn-xs'>View Results</button>
                                        </form></center></td>
                                  </tr>";
                          }
                      }
