...
function paymentTable($type){
  ...
  echo "<br><small>Total amount due : BDT ".$totalDue."</small>
      ...
      <form action='compose.php' method='post'>
        <input type='hidden' value='".$row['stuff_id']."' name='id'>
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Payments <small>Stuff</small></h3>
              </div>
                ...
                <div class="x-panel">
                  <div class="" role="tabpanel" data-example-id="togglable-tabs">
                        <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                          ...
                          <li role="presentation" class=""><a href="#tab_content2" role="tab" id="profile-tab" data-toggle="tab" aria-expanded="false">Official Stuff</a>
                          </li>
                        </ul>
