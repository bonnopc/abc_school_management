...
<html lang="en">
  <head>
    ...
    <title>Class 09 - Students - ABC School</title>
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Class 09 <small>Present Students'<?php echo $newYear;?></small></h3>
              </div>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-responsive" class="table table-striped table-bordered">
                      ...
                      $sql = "SELECT * FROM class09 WHERE year = '$year'";
                      $result = mysqli_query($conn, $sql);
                           ...
                           //   foreach($row as $key => $value)
                            //  {
                                  ...
                                  <tr>
                                    ...
                                    <td>".$row['email']."</td>
                                    <td><center>
                                    <form action='stu_result_c09.php' method='post'>
                            ...
                            <input type='hidden' name='chooseclass' value='".$row['class']."'>
